			...
			<div className="sticky top-0 z-50 max-w-5xl mx-auto px-8">
				<nav className="h-14 flex items-center justify-between bg-white/80 dark:bg-neutral-950/80 backdrop-blur-sm border-b border-neutral-200 dark:border-neutral-800">
					...
					<div className="flex items-center gap-1">
						...
						<a href="/playground" className="px-3 py-1.5 text-sm text-black dark:text-white">
							Playground
						</a>
						...
						<div className="flex items-center justify-between mb-6">
							...
							{timing && (
								<div className="flex items-center gap-4 text-xs font-mono text-neutral-400">
									...
									{result?.meta?.cache && (
										<span
											className={`px-2 py-0.5 ${result.meta.cache.status === "HIT" ? "bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400" : "bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400"}`}
										>
										...
										<div className="p-4">
											<div className="flex items-center gap-2 mb-2">
												...
												<span className="text-xs text-neutral-400">
													{result.data.siteName || result.data.domain}
												</span>
											</div>
				...
				<section className="py-12 border-b border-neutral-200 dark:border-neutral-800">
					...
					<div className="grid grid-cols-3 gap-4 font-mono text-sm">
						{[
							...
							<div
								key={item.field}
								className="p-3 border border-neutral-200 dark:border-neutral-800"
							>
