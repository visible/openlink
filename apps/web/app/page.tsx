			...
			<div className="sticky top-0 z-50 max-w-5xl mx-auto px-8">
				<nav className="h-14 flex items-center justify-between bg-white/80 dark:bg-neutral-950/80 backdrop-blur-sm border-b border-neutral-200 dark:border-neutral-800">
					...
					<div className="flex items-center gap-1">
						<a
							href="/docs"
							className="px-3 py-1.5 text-sm text-neutral-600 dark:text-neutral-400 hover:text-black dark:hover:text-white hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
						>
							{t.nav.docs}
						</a>
						<a
						...
						<a
							href="https://github.com/visible/OpenLink"
							className="flex items-center gap-2 px-3 py-1.5 text-sm text-neutral-600 dark:text-neutral-400 hover:text-black dark:hover:text-white hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
						>
							<svg
								width="16"
								height="16"
			...
			<div className="max-w-5xl mx-auto px-8 py-16">
				<section className="grid grid-cols-2 gap-16 pb-24 border-b border-neutral-200 dark:border-neutral-800">
					<div className="flex flex-col">
						...
						<p className="text-lg text-neutral-500 dark:text-neutral-400 leading-relaxed mb-10">
							{t.hero.description}
						</p>
						<div className="flex items-center gap-3 mt-auto">
							<a
								href="/docs"
								className="get-started px-5 py-2.5 bg-black dark:bg-white text-sm font-medium"
							>
								{t.nav.getStarted}
							</a>
							<a
								href="https://github.com/visible/OpenLink"
								className="px-5 py-2.5 border border-black dark:border-white text-sm font-medium hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors"
							>
								GitHub
							</a>
						</div>
							...
							<div className="space-y-4">
								<div>
									<p className="flex items-center gap-2">
										...
										<span>
											<span className="text-neutral-500">await</span> preview
											<span className="text-neutral-500">(</span>
											<span className="text-emerald-600 dark:text-emerald-400">"github.com"</span>
											<span className="text-neutral-500">)</span>
										</span>
									</p>
								</div>
								<div className="mt-4 pt-4 border-t border-neutral-200 dark:border-neutral-800">
									...
									<p className="pl-4">
										image<span className="text-neutral-500">:</span>{" "}
										<span className="text-emerald-600 dark:text-emerald-400">
											"https://github.githubassets..."
										</span>
									</p>
									<p className="pl-4">
										favicon<span className="text-neutral-500">:</span>{" "}
										<span className="text-emerald-600 dark:text-emerald-400">
				...
				<section className="py-24 border-b border-neutral-200 dark:border-neutral-800">
					...
					<p className="text-neutral-500 dark:text-neutral-400 mb-8 max-w-2xl font-mono text-sm">
						<span className="text-neutral-400">[*]</span> OpenLink is an open source library that
						extracts metadata from any URL. Zero dependencies, TypeScript native, and runs anywhere
						JavaScript runs.
					</p>
					<a
						href="/docs"
						className="inline-flex items-center gap-2 px-4 py-2 border border-neutral-300 dark:border-neutral-700 text-sm font-mono hover:border-black dark:hover:border-white transition-colors"
					>
				...
				<section className="py-24 border-b border-neutral-200 dark:border-neutral-800">
					...
					<p className="text-neutral-500 dark:text-neutral-400 mb-16 max-w-3xl font-mono text-sm">
						<span className="text-neutral-400">[*]</span> With only{" "}
						<span className="text-black dark:text-white font-semibold">{specs.size}</span> gzipped,{" "}
						<span className="text-black dark:text-white font-semibold">{specs.deps}</span>{" "}
						dependencies, and{" "}
						<span className="text-black dark:text-white font-semibold">{specs.parse}</span> average
						parse time, OpenLink is built for performance at the edge.
					</p>
				...
				<section className="py-24 border-b border-neutral-200 dark:border-neutral-800">
					...
					<div className="flex items-center gap-4">
						{["Vercel Edge", "Cloudflare Workers", "Deno Deploy", "Node.js", "Bun"].map((r) => (
							<span
								key={r}
								className="px-4 py-2 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 text-sm"
							>
								{r}
							</span>
						))}
				...
				<section className="py-24 border-b border-neutral-200 dark:border-neutral-800">
					...
					<p className="text-lg text-neutral-500 dark:text-neutral-400 mb-8 max-w-2xl">
						Use OpenLink as a tool for any AI model with function calling. Extract link previews in
						your agents, chatbots, and AI applications.
					</p>
